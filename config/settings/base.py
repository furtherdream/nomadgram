...
THIRD_PARTY_APPS = [
    ...
    'rest_framework.authtoken', # REST Authtoken
    'rest_auth', # REST Auth
...
# LOGIN_URL = 'account_login' => rest-auth 설치 후 삭제
...
ADMINS = [
    ("""hanseungho""", 'hanhansss@naver.com'),
]
...
REST_USE_JWT = True  # JWT사용
ACCOUNT_LOGOUT_ON_GET = True  # get을 이용한 로그아웃 처리